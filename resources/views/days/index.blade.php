                    ...
                    <form action="{{route('days.store')}}" method="POST">
                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                @enderror
                                <input type="text" name="name" id="name" class="form-control form-control-sm rounded-0" placeholder="Enter Days Name"/>
                            </div>
                    ...
                    <table id="mytable" class="table table-sm table-hover border">
                        ...
                        @foreach($days as $idx=>$day)
                            <tr>
                                ...
                                <td>{{$day->updated_at->format('d M Y h:m:s')}}</td>
                                <td>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('.delete-btn').click(function(){
            ...
            if(confirm(`Are you sure you want to delete day ${getidx}?`)){
