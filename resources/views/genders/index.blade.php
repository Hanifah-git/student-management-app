                    ...
                    <form action="{{route('genders.store')}}" method="POST">
                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                @enderror
                                <input type="text" name="name" id="name" class="form-control form-control-sm rounded-0" placeholder="Enter Gender"/>
                            </div>
                    ...
                    <table id="mytable" class="table table-sm table-hover border">
                        ...
                        @foreach($genders as $idx=>$gender)
                            <tr>
                                ...
                                <td>{{$gender->updated_at->format('d M Y h:m:s')}}</td>
                                <td>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('.delete-btn').click(function(){
            ...
            if(confirm(`Are you sure you want to delete gender ${getidx}?`)){
