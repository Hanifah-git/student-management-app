                ...
                <div class="col-md-12">
                    <table id="mytable" class="table table-sm table-hover border">
                        ...
                        @foreach($warehouses as $idx=>$warehouse)
                            <tr>
                                <td>
                                    <input type="checkbox" name="singlechecks" class="form-check-input singlechecks" value="{{$warehouse->id}}"/>
                                </td>
                                <td>{{++$idx}}</td>
                                ...
                                <td>{{$warehouse->updated_at->format('d M Y h:m:s')}}</td>
                                <td>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('.delete-btn').click(function(){
            ...
            if(confirm(`Are you sure you want to delete warehouse ${getidx}?`)){
